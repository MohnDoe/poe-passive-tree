...
export interface PassiveTreeRootNodeDto extends PassiveTreeNodeBaseDto {
...
export function isPassiveNode(node: PassiveTreeNodeEntryDto | undefined): node is PassiveTreeNodeDto {
